...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //IndicatorViewController *aViewController = [IndicatorViewController new];
    
    //IndicationWebViewController *aViewController = [IndicationWebViewController new];

//    IndicationCollectionViewController *aViewController = [IndicationCollectionViewController new];
