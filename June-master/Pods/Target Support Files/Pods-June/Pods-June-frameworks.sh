...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Actions/Actions.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Feathers/Feathers.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FeathersSwiftSocketIO/FeathersSwiftSocketIO.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MGEvents/MGEvents.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SGHTTPRequest/SGHTTPRequest.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SGImageCache/SGImageCache.framework"
