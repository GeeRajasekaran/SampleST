...
protocol ConvosNewViewDelegate: class {
    func convosNewView(didTapItem sender: ConvosNewView)
}

class ConvosNewView: UIView {
    ...
    weak var delegate: ConvosNewViewDelegate?
    ...
    func setupView() {
        ...
        clearButton.addTarget(self, action: #selector(ConvosNewView.clearButtonPressed(_:)), for: .touchUpInside)
        addSubview(clearButton)
        
        clearButtonOverlay.sizeToFit()
        clearButtonOverlay.addTarget(self, action: #selector(ConvosNewView.clearButtonPressed(_:)), for: .touchUpInside)
    ...
    @objc func clearButtonPressed(_ sender: UIButton) {
        ...
        if let delegate = self.delegate {
            delegate.convosNewView(didTapItem: self)
        }
    }
