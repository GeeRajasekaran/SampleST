...
class CLTokenView: UIView, UIKeyInput {
    ...
    var selectedLabel = UILabel() // var selectedLabel:UILabel!
    ...
    init(frame:CGRect, token: CLToken, font:UIFont?) {
        ...
        self.label.font = UIFont(name: "Proxima Nova", size: 11)
        ...
        self.selectedLabel.textColor = UIColor.red
        self.selectedLabel.backgroundColor = UIColor.gray
    ...
    override func tintColorDidChange() {
        ...
        self.label.textColor = UIColor.black //tintColor
        self.selectedBackgroundView.backgroundColor = tintColor
        self.updateLabelAttributedText()
    }
    
    
    @objc func handleTapGestureRecognizer(_ sender:UIGestureRecognizer) {
...
//        }
    ...
    func updateLabelAttributedText() {
        ...
        let attributes = [ NSAttributedStringKey.font.rawValue: self.label.font, NSAttributedStringKey.foregroundColor: UIColor.lightGray] as! [NSAttributedStringKey : Any]
    ...
    override func layoutSubviews() {
        ...
        var labelFrame = bounds.insetBy(dx: CGFloat(PADDING_X), dy: (0))
        self.selectedLabel.frame = labelFrame
        self.selectedLabel.font = UIFont(name: "Proxima Nova", size: 11)
        self.selectedLabel.textColor = UIColor(red:0.6, green:0.66, blue:0.97, alpha:1)
